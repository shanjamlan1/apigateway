...
//routes for site2
$router->get('/users2','User2Controller@index'); //get all users from site 1
$router->post('/users2', 'User2Controller@addUser'); //create new user from site 1
$router->get('/users2/{id}', 'User2Controller@showUser'); //get user using a specific user id from site 1
$router->put('/users2/{id}', 'User2Controller@updateUser'); //update users using a specific user id from site 1
$router->delete('/users2/{id}', 'User2Controller@deleteUser'); //delete users using a specific user id from site 1
